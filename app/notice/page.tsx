      ...
      <main className="flex-grow max-w-6xl mx-auto py-16 px-4 w-full">
        ...
        <div className="grid gap-6 min-h-[400px]">
          {loading ? (
            ...
            <Link key={post.id} href={`/notice/${post.id}`} className="w-full bg-gray-200/50 hover:bg-gray-200 transition-colors p-3 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg block transition-all overflow-hidden">
